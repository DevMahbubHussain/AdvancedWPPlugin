...
function twentytwenty_theme_support() {
	...
	add_action( 'mht_content', 'mht_display_meta', 10 );
	function mht_display_meta(){
		$singers = get_the_terms( $post->ID, 'singers' );		
		?>
			<h1><?php the_title(); ?></h1>
			<div class="meta">
				<span class="singer"><strong><?php _e( 'Singer', 'mh-translations' ); ?>:</strong>
					<?php foreach( $singers as $singer ): ?>
						<a href="<?php echo esc_url( get_term_link( $singer ) ) ?>"><?php echo esc_html( $singer->name ); ?></a>
					<?php endforeach; ?>
				</span>
				<span class="author"><strong><?php _e( 'Author', 'mh-translations' ); ?>: </strong>
					<?php the_author_posts_link(); ?>
				</span>
				<span class="the-date"><strong><?php _e( 'Published on', 'mh-translations' ); ?>: </strong>
					<?php the_date(); ?>
				</span>                            
			</div>		
		<?php
	...
	add_action( 'mht_content', 'mht_display_content', 11 );
	function mht_display_content(){
		?>
			<div class="content">
				<?php the_content(); ?>                            
			</div>		
